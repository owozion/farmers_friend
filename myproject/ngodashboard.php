...
$t=$programme->fetch_programme_two($id);

$f = new Farmer;

$ngo = new Ngo;
$ngo = $ngo->get_ngo_by_id($id);
...
$application = $progapplication->get_farmer_application_ngo($id);
           ...
           <div class="row head"> 
            ...
            <div class="row">
                <div class="col-md-2 shadow m-3 produce">
                   ...
                   <p> Welcome <?php echo $ngo['ngo_firstname'];?></p>
                   
                    <img src="uploads/<?php echo $ngo['ngo_profilep'];?>" height="80" class="d-block w-55 img-fluid rounded-top-5 rounded-bottom-5 img-thumbnail rounded-circle" alt="Profile picture">
                ...
                <div class="col-md-8 shadow m-3 produce dashboard">
                    ...
                    <h1 class="dashb  pb-5">Saving the Universe from Hunger and Global Warming.</h1>
                    <?php
                ...
                ?>
                    <!-- Add Programme -->
                    <form class="row g-3 overlay " id="addproduct" action="process/process_programmes.php" method="post" enctype="multipart/form-data">
                        <h6 class="profile" style="color: black">Add Agricultural Support Programme</h6>
                        <div class="col-md-6">
                            <label for="inputname" class="form-label" style="color: black">Programme Name</label>
                            <input type="text" name="name" class="form-control" id="inputname" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputquantity" class="form-label" style="color: black">Programme Goal</label>
                            <input type="text" name="goal" class="form-control" id="productqty" required>
                        </div>
                        <div class="col-md-6">
                            <label for="price" class="form-label" style="color: black">Amount Invested</label>
                            <input type="number" name="amount" class="form-control" id="productprice"required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputquantity" class="form-label" style="color: black">Number of farmers targeted</label>
                            <input type="number" name="qty" class="form-control" id="productqty" required>
                        </div>
                        <div> 
                        ...
                        <div class="col-12">
                            ...
                            <label class="form-check-label" style="color: black" for="gridCheck" required>
                        ...
                        <input class="btn btn-warning mb-3 align-center" id="btnaddproduct" name="btnprogrammes" type="submit" value="Add Product">                            
                        </div>
                    </form>
                                  

                <!-- Ngo Update-->
                    <form class="row g-3 pb-5" id="editprofile" action="process/process_ngoprofile.php" method="post" enctype="multipart/form-data">
                        <h6 class="profile">Edit Profile</h6>
                        <div class="col-md-6">
                            <label for="" class="form-label">Firstname</label>
                            <input type="name" name="fname" value="<?php echo $ngo['ngo_firstname'];?>" class="form-control" id="name" required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label">Surname</label>
                            <input type="name" name="lname" value="<?php echo $ngo['ngo_lastname'];?>" class="form-control" id="inputsurname" required>
                        </div>
                        <div class="col-md-6">
                            <label for="" class="form-label">Email</label>
                            <input type="email" name="email" value="<?php echo $ngo['ngo_email'];?>" class="form-control" id="email"required>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <label class="form-check-label" for="gridCheck" required>
                                Please confirm you inputed your correct information
                            </label>
                            </div>
                        </div>
                        <div class="col-12">
                        <input class="btn btn-warning" id="btnupdate" name="ngoupdate" type="submit" value="Update Profile!">                            
                        </div>
                        </form>

                <!-- view Agricultural Support Programmes -->
...
<tr>
      ...
      <a onclick="return confirm('Are you sure you want to delete')" href="delete_ngoprogramme.php?id=<?php echo $pro['programme_id'];?>" class="btn btn-sm btn-danger">Delete</a></td>
  </tr>
<?php
$counter ++;
      }
...
<tr>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a class="dropdown-item" href="status_ngo.php?id=<?php echo $pro['programmedetails_id']?>&value=Approved">Approved</a></li>
    <li><a class="dropdown-item" href="status_ngo.php?id=<?php echo $pro['programmedetails_id']?>&value=Decline">Decline</a></li>
  </ul>
</div></td>
  </tr>
<?php
